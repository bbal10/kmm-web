...
class StudentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Identity Info", {"fields": ("passport_number", "lapdik_number", "arrival_date")}),
        (
            "Contact & Residence",
            {"fields": ("parents_name", "parents_phone", "home_name", "home_location")},
        ),
        ("Guardian Information", {"fields": ("photo_url", "guardian_name", "guardian_phone")}),
        ("Health Information", {"fields": ("disease_history", "disease_status")}),
        (
        ...
        ("Organizational History", {"fields": ("organization_history",)}),
        (
