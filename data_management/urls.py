...
urlpatterns = [
    ...
    path(
        ...
        views.StaffDashboardDataListView.as_view(),
        name="staff_student_list",
    ),
    path(
        "dashboard/staff/students/add/",
        views.StaffStudentCreateView.as_view(),
        name="staff_student_create",
    ),
    path(
        "dashboard/staff/students/<int:pk>/",
        views.StaffStudentDetailView.as_view(),
        name="staff_student_detail",
    ),
    path(
        "dashboard/staff/students/export/csv/",
        views.export_students_csv,
        name="export_students_csv",
    ),
    path(
        "dashboard/staff/students/<int:pk>/edit/",
        views.StaffStudentUpdateView.as_view(),
        name="staff_student_edit",
    ),
    path(
        "dashboard/staff/students/<int:pk>/reset-password/",
        views.staff_student_reset_password,
        name="staff_student_reset_password",
    ),
    path(
        "dashboard/staff/students/<int:pk>/delete/",
        views.StaffStudentDeleteView.as_view(),
